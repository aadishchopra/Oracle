...
#### Top 3 Movies released in Summer 
...
U.Item$release_date<-as.Date(U.Item$release_date,format="%d-%b-%y")
U.Item$release_date<-format (U.Item$release_date, "%b")
U_Summer_Item<-U.Item[U.Item$release_date %in% c("May","June","July"),]
