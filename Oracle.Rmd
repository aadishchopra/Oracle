...
split(Top3OccupationGenre,f = c(Top3OccupationGenre$occupation,Top3OccupationGenre$genre_transformed))

groupby_head<-lapply(split(Top3OccupationGenre,f = c(Top3OccupationGenre$occupation,Top3OccupationGenre$genre_transformed))
, head,n=3)

Top3OccupationGenre1<-do.call(rbind,groupby_head)

alias<-aggregate(Top3OccupationGenre,by=list(Top3OccupationGenre$occupation,Top3OccupationGenre$genre_transformed),FUN=head, n=3)
