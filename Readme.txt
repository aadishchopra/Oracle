------Readme file contains information about the files attached to the email in regards to completion
of the assessment ----------------------------------------------------------------------------------

1. Oracle.R - files which contains solutions to all problems except the recommendation problem. No packages were 
